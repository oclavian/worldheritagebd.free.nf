              ...
              <div className="p-5 sm:p-6 space-y-4 bg-white">
                {pkg.itinerary.map((item, idx) => {
                  ...
                  return (
                    <div
                      key={idx}
                      className={`p-4 sm:p-5 rounded-2xl border space-y-2.5 transition-all ${
                        isDay10
                    ...
                    >
                      <div className="flex flex-wrap items-center justify-between gap-2.5 border-b border-slate-200/80 pb-2.5">
                        <div className="flex items-center gap-2.5 flex-wrap">
                          <span className={`px-3 py-1 rounded-full font-black text-xs sm:text-sm whitespace-nowrap shadow-sm tracking-wide shrink-0 ${

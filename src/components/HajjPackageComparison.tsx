...
import { 
  CheckCircle2, XCircle, Train, Plane, MapPin, Sparkles, Building, Utensils, 
  Award, ShieldCheck, Gift, Compass, Clock, CreditCard, ChevronRight, Check, Minus, Info
} from 'lucide-react';
...
export const HajjPackageComparison: React.FC<HajjPackageComparisonProps> = ({
  ...
  const isBn = lang === 'bn';
  const [activeCategory, setActiveCategory] = useState<'all' | 'transport' | 'hotels' | 'ziyarah' | 'gifts'>('all');
      ...
      items: [
        ...
        },
        {
          ...
          standard: {
            ...
            subEn: 'Ultra-fast & comfortable 2-hr high-speed luxury rail journey',
            status: 'special',
          },
        },
        {
      ...
      items: [
        {
          ...
          economy: {
            ...
            subBn: 'জাবালে নূর (হেরা গুহা), সাওর পর্বত, মিনা, মুজদালিফা ও আরাফাত',
            subEn: 'Jabal al-Nour (Hira), Mount Thawr, Mina, Muzdalifah & Arafat',
            status: 'included',
          },
          standard: {
            textBn: 'সম্পূর্ণ মক্কা জিয়ারাহ অন্তর্ভুক্ত',
        ...
        },
        {
          ...
          economy: {
            ...
            subBn: 'মসজিদে কুবা, ওহুদ প্রান্তর ও শহীদদের কবর, মসজিদে কিবলাতাইন ও সাত মসজিদ',
            subEn: 'Masjid Quba, Mount Uhud martyrs, Masjid Qiblatain & Khandaq',
            status: 'included',
          },
          standard: {
            textBn: 'সম্পূর্ণ মদিনা জিয়ারাহ অন্তর্ভুক্ত',
        ...
        },
        {
          ...
          standard: {
            ...
            subBn: 'রাসূলুল্লাহ (সাঃ)-এর স্মৃতিবিজড়িত তায়েফ উপত্যকা, জেদ্দার ফ্লোটিং মসজিদ ও ঐতিহাসিক বদর প্রান্তর দর্শন',
            subEn: 'Historic Taif Valley, Jeddah Floating Mosque & historic Badr Battleground tour',
            status: 'special',
          },
        },
      ],
      ...
      items: [
        {
          ...
          standard: {
            ...
            subBn: 'প্রিমিয়াম ইহরাম সেট, ব্র্যান্ডেড ট্রলিব্যাগ, হ্যান্ডব্যাগ, জায়নামাজ ও হজ্ব কিট বক্স',
            subEn: 'Premium Ihram set, branded trolley bag, handbag, prayer mat & luxury Hajj kit box',
            status: 'special',
          },
        },
        {
          ...
          economy: {
            ...
            subEn: 'Hands-on practical training at Dhaka office prior to departure',
            status: 'included',
          },
          standard: {
            textBn: 'হজ্ব প্রশিক্ষণ কর্মশালা ও সার্বক্ষণিক ভিআইপি মোয়াল্লেম গাইড',
            textEn: 'Hajj Workshop & 24/7 VIP Moallem Guide',
            subBn: 'যাত্রা শুরুর পূর্ব থেকে সৌদি আরবে সম্পূর্ণ অবস্থানকালীন সার্বক্ষণিক সহায়তা',
            subEn: 'Dedicated round-the-clock scholar & guide throughout the journey',
            status: 'special',
          },
        },
        {
        ...
        <div className="relative z-10 space-y-4">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="inline-flex items-center gap-2 bg-[#D4AF37]/20 border border-[#D4AF37]/50 text-[#F3E0A0] text-xs font-bold px-3.5 py-1.5 rounded-full backdrop-blur-xs">
              ...
              <span>{isBn ? 'প্যাকেজ নির্বাচন গাইড' : 'Package Selection Guide'}</span>
            </div>
            <span className="text-xs text-emerald-200 font-semibold bg-emerald-950/60 px-3 py-1 rounded-lg border border-emerald-500/30">
              {isBn ? '২০২৭ সালের সরকারি অনুমোদন সাপেক্ষে' : 'Subject to Govt Approval 2027'}
            </span>
          </div>

          <div>
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-white">
              {isBn ? 'ইকোনমি বনাম স্ট্যান্ডার্ড হজ্ব প্যাকেজ তুলনা' : 'Economy vs Standard Hajj Package Comparison'}
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-3">
            ...
            <div className="bg-white/10 backdrop-blur-md p-4 sm:p-5 rounded-2xl border border-white/15 space-y-3 hover:bg-white/15 transition-all">
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-xs text-emerald-200 font-bold">{isBn ? 'শুরুর মূল্য:' : 'Starting at:'}</span>
                <span className="text-2xl font-black text-[#F3E0A0]">৳৬,৩০,০০০/-</span>
                <span className="text-[11px] text-emerald-200">{isBn ? '/ জন' : '/ person'}</span>
              </div>

              <ul className="text-xs text-emerald-100 space-y-1.5 pt-1 border-t border-white/10">
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                  <span>{isBn ? 'ডিরেক্ট ফ্লাইট ও কোরবানি অন্তর্ভুক্ত' : 'Direct Flights & Qurbani Included'}</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                  <span>{isBn ? 'মক্কা ৫০০মিঃ ও মদিনা ১০০মিঃ হোটেল' : 'Makkah 500m & Madinah 100m Hotel'}</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                  <span>{isBn ? 'মক্কা ও মদিনার ঐতিহাসিক স্থান জিয়ারাহ' : 'Makkah & Madinah Holy Ziyarah'}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#8B0000]/60 to-black/60 backdrop-blur-md p-4 sm:p-5 rounded-2xl border-2 border-[#D4AF37]/80 space-y-3 relative shadow-lg">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-base sm:text-lg font-black text-[#FAF8F5]">
                    {isBn ? 'স্ট্যান্ডার্ড হজ্ব প্যাকেজ' : 'Standard Hajj Package'}
                  </h3>
                </div>
              </div>

              <div className="flex items-baseline gap-2">
                <span className="text-xs text-amber-200 font-bold">{isBn ? 'শুরুর মূল্য:' : 'Starting at:'}</span>
                <span className="text-2xl font-black text-[#F3E0A0]">৳৭,৫০,০০০/-</span>
                <span className="text-[11px] text-amber-200">{isBn ? '/ জন' : '/ person'}</span>
              </div>
              ...
              <ul className="text-xs text-amber-100 space-y-1.5 pt-1 border-t border-white/10">
                <li className="flex items-center gap-2 font-bold text-[#F3E0A0]">
                  ...
                  <span>{isBn ? '★ মক্কা-মদিনা হারামাইন দ্রুতগতির বুলেট ট্রেন অন্তর্ভুক্ত' : '★ Makkah-Madinah Haramain Bullet Train Included'}</span>
                </li>
                <li className="flex items-center gap-2 font-bold text-[#F3E0A0]">
                  <Sparkles className="w-3.5 h-3.5 text-[#D4AF37] shrink-0" />
                  <span>{isBn ? '★ তায়েফ, জেদ্দা ও বদর বিশেষ ঐতিহাসিক জিয়ারাহ' : '★ Taif, Jeddah & Badr Special Ziyarah Included'}</span>
                </li>
                <li className="flex items-center gap-2">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400 shrink-0" />
                  <span>{isBn ? 'এক্সক্লুসিভ লাক্সারি কিট ও ট্রলিব্যাগ সেট' : 'Exclusive Luxury Kit & Trolley Bag Set'}</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div className="bg-white rounded-3xl border-2 border-slate-200/90 shadow-lg overflow-hidden">
                  ...
                  {category.items.map((item, idx) => {
                    ...
                    return (
                      ...
                      >
                            ...
                            <div>
                              ...
                              {isKey && (
                                <span className="block text-[10px] font-bold text-[#8B0000] mt-0.5">
                                  {isBn ? '★ মূল পার্থক্য' : '★ Key Distinction'}
                                </span>
                              )}
                            </div>
                          </div>
                          ...
                          {item.economy.status === 'excluded' ? (
                            <div className="space-y-1">
                              <span className="inline-flex items-center gap-1 text-xs sm:text-sm font-bold text-slate-500 bg-slate-100 px-2.5 py-1 rounded-lg border border-slate-200">
                                ...
                                <span>{isBn ? item.economy.textBn : item.economy.textEn}</span>
                              </span>
                              {item.economy.subBn && (
                                <p className="text-[11px] text-slate-500 font-medium leading-tight">
                                  {isBn ? item.economy.subBn : item.economy.subEn}
                                </p>
                              )}
                            </div>
                          ) : (
                            <div className="space-y-1">
                              <div className="flex items-start gap-1.5">
                                ...
                                <span className={`text-xs sm:text-sm font-bold leading-snug ${
                                  ...
                                  {isBn ? item.economy.textBn : item.economy.textEn}
                                </span>
                              </div>
                              {item.economy.subBn && (
                        ...
                        <div className={`col-span-4 sm:col-span-4 p-3 sm:p-4 flex flex-col justify-center ${
                          ...
                          <div className="space-y-1">
                            <div className="flex items-start gap-1.5">
                              ...
                              <span className={`text-xs sm:text-sm font-bold leading-snug ${
                                ...
                                {isBn ? item.standard.textBn : item.standard.textEn}
                              </span>
                            </div>
                            {item.standard.subBn && (
                              <p className={`text-[11px] font-medium leading-tight pl-5.5 ${
                                item.standard.status === 'special' ? 'text-[#8B0000]/90 font-bold' : 'text-slate-600'
                              }`}>
                                {isBn ? item.standard.subBn : item.standard.subEn}
                              </p>
                            )}
                          </div>
                        </div>
        ...
        <div className="grid grid-cols-12 bg-slate-100 p-4 sm:p-6 border-t-2 border-slate-300 gap-2 sm:gap-4 items-center">
          <div className="col-span-5 sm:col-span-4 text-xs font-bold text-slate-700">
            {isBn ? 'আপনার পছন্দের প্যাকেজে আজই নিবন্ধন করুন:' : 'Register for your preferred package:'}
          </div>

          <div className="col-span-3 sm:col-span-4">
            <button
              onClick={() => onOpenBookingModal('Hajj', isBn ? '২০২৭ সালের পবিত্র হজ্ব প্যাকেজ (ইকোনমি - ৳৬,৩০,০০০)' : 'Hajj 2027 Economy Package')}
          ...
          <div className="col-span-4 sm:col-span-4">
            <button
              onClick={() => onOpenBookingModal('Hajj', isBn ? '২০২৭ সালের পবিত্র হজ্ব প্যাকেজ (স্ট্যান্ডার্ড - ৳৭,৫০,০০০)' : 'Hajj 2027 Standard Package')}

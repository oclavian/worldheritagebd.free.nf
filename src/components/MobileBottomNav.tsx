    ...
    <>
      ...
      >
        <div className="max-w-lg mx-auto grid grid-cols-6 items-center gap-0.5">
          ...
          >
            <div
              className={`p-0.5 rounded-lg transition-transform ${activePage === "home" ? "scale-110 text-[#D4AF37]" : ""}`}
            >
          ...
          >
            <div
              className={`p-0.5 rounded-lg transition-transform ${activePage === "umrah" ? "scale-110 text-[#D4AF37]" : ""}`}
            >
          ...
          >
            <div
              className={`p-0.5 rounded-lg transition-transform ${activePage === "hajj" ? "scale-110 text-[#D4AF37]" : ""}`}
            >
          ...
          >
            <div
              className={`p-0.5 rounded-lg transition-transform ${activePage === "tours-visas" ? "scale-110 text-[#D4AF37]" : ""}`}
            >
          ...
          >
            <div
              className={`p-0.5 rounded-lg transition-transform ${drawerOpen ? "scale-110 text-[#D4AF37]" : ""}`}
            >
                ...
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="font-extrabold text-white text-base">
                      {lang === "bn"
                        ? "সকল সেবা ও সেকশনসমূহ"
                        : "All Services & Sections"}
                    </h3>
                    <p className="text-xs text-[#D4AF37] font-medium">
                      {lang === "bn"
                        ? "ওয়ার্ল্ড হেরিটেজ ট্যুরস অ্যান্ড ট্রাভেলস"
              ...
              <div className="p-4 overflow-y-auto space-y-3 flex-1 divide-y divide-emerald-900/50">
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5">
                            <span
                              className={`text-sm font-extrabold truncate ${isActive ? "text-emerald-950" : "text-white"}`}
                            >
                          ...
                          <p
                            className={`text-[11px] truncate mt-0.5 ${isActive ? "text-emerald-900 font-medium" : "text-emerald-200/70"}`}
                          >
                        ...
                        <ChevronRight
                          className={`w-4 h-4 shrink-0 ${isActive ? "text-emerald-950" : "text-[#D4AF37]"}`}
                        />
                      </button>
                    );
                  })}
                ...
                <div className="pt-3 space-y-2.5">
                  ...
                  >
                    <span>
                      {lang === "bn"
                        ? "অনলাইন হজ্ব ও উমরাহ্ বুকিং করুন"
                        : "Book Hajj & Umrah Online"}
                    </span>

          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base sm:text-lg font-extrabold text-white font-sans tracking-tight">
                {isBn
                  ? "সরাসরি যোগাযোগ ও বুকিং তথ্য"
                  : "Direct Booking & Contact Info"}
              </h3>
              <p className="text-xs text-[#D4AF37] font-semibold">
                {isBn
                  ? "ওয়ার্ল্ড হেরিটেজ ট্যুর্স অ্যান্ড ট্রাভেলস"
        ...
        <div className="p-5 sm:p-6 overflow-y-auto space-y-5 text-white">
            ...
            <div className="space-y-1">
              <p className="text-sm sm:text-base leading-relaxed">
                <strong className="text-emerald-300 font-bold">
                  {isBn ? "বিকল্প যোগাযোগ:" : "Alt Phone:"}
                </strong>{" "}
                <a
                  href="tel:01785970008"
                  className="hover:text-[#D4AF37] transition-colors font-bold font-sans underline text-white"
                >
                  {isBn
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-1">
            ...
            >
              ...
              <span>
                {isBn ? "হোয়াটসঅ্যাপে মেসেজ দিন" : "WhatsApp Message"}
              </span>
            </a>

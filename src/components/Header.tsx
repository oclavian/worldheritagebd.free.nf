...
export const Header: React.FC<HeaderProps> = ({
  ...
  const navItems: {
    id: PageId;
    labelKey: keyof (typeof import("../data/translations").translations)["bn"];
  }[] = [
  ...
  return (
    <header
      className={`sticky top-0 z-40 bg-[#052917] text-white shadow-lg border-b border-[#D4AF37]/40 ${lang === "bn" ? "font-bengali" : "font-english"}`}
    >
            ...
            <div className="pt-3 border-t border-slate-100 space-y-2">
              ...
              <div className="bg-emerald-50 p-3 rounded-xl border border-emerald-100 text-xs text-emerald-950 space-y-1.5">
                <a
                  ...
                  className="flex items-center gap-2 font-bold text-[#0D472B]"
                >

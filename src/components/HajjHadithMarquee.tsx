...
import { BookOpen, Volume2, Pause, Play, Sparkles, ChevronRight, X } from 'lucide-react';
...
export const hadithQuotes = [
  {
    ...
    arabic: 'وَلِلَّهِ عَلَى النَّاسِ حِجُّ الْبَيْتِ مَنِ اسْتَطَاعَ إِلَيْهِ سَبِيلًا ۚ وَمَن كَفَرَ فَإِنَّ اللَّهَ غَنِيٌّ عَنِ الْعَالَمِينَ',
    textBn: 'আল্লাহ তাআলা ইরশাদ করেছেন— মানুষের মধ্যে যারা সেখানে (বায়তুল্লাহ) পৌঁছার সামর্থ্য রাখে তাদের উপর আল্লাহর উদ্দেশ্যে এ গৃহের হজ্ব করা ফরয। আর কেউ যদি অস্বীকার করে তাহলে জেনে রাখা উচিত যে, আল্লাহ তাআলা সৃষ্টিজগতের প্রতি মুখাপেক্ষী নন।',
    textEn: 'And pilgrimage to the House is a duty unto Allah for mankind, for him who can find a way thither. And whosoever disbelieveth, Allah is Independent of all creatures.'
  },
  {
    id: 2,
    source: 'মুসনাদে আহমদ: ১৮৩৩; ইবনে মাজাহ: ২৮৮৩; আবু দাউদ: ১৭৩২',
    sourceEn: 'Musnad Ahmad: 1833; Ibn Majah: 2883; Abu Dawud: 1732',
    arabic: 'مَنْ أَرَادَ الْحَجَّ فَلْيَتَعَجَّلْ، فَإِنَّهُ قَدْ يَمْرَضُ الْمَرِيضُ وَتَضِلُّ الضَّالَّةُ وَتَعْرِضُ الْحَاجَةُ',
    textBn: 'রাসূলে কারীম (সা.) ইরশাদ করেছেন— যে ব্যক্তি হজ্ব করার ইচ্ছে করে, সে যেন তাড়াতাড়ি তা আদায় করে নেয়। কারণ যে কোনো সময় সে অসুস্থ হয়ে যেতে পারে বা বাহনের ব্যবস্থার ব্যাঘাত হতে পারে অথবা অন্য কোনো সমস্যার সম্মুখীন হতে পারে।',
    textEn: 'The Prophet (PBUH) said: Whoever intends to perform Hajj, let him hasten to do so, for he may fall ill, his riding animal may go astray, or some necessity may arise.'
  },
  {
    id: 3,
    source: 'মুসনাদে আহমদ: ২৮৬৭; সুনানে কুবরা বায়হাকী: ৪/৩৪০',
    sourceEn: 'Musnad Ahmad: 2867; Sunan al-Kubra Bayhaqi: 4/340',
    arabic: 'تَعَجَّلُوا إِلَى الْحَجِّ - يَعْنِي الْفَرِيضَةَ - فَإِنَّ أَحَدَكُمْ لَا يَدْرِي مَا يَعْرِضُ لَهُ',
    textBn: 'রাসূলুল্লাহ (সা.) ইরশাদ করেছেন— ফরয হজ্ব আদায়ে তোমরা বিলম্ব করো না। কারণ তোমাদের কারো জানা নেই তোমাদের পরবর্তী জীবনে কী ঘটবে।',
    textEn: 'The Prophet (PBUH) said: Hasten to perform Hajj (the obligatory one), for none of you knows what obstacles may happen to him.'
  },
  {
    id: 4,
    source: 'সহীহ ইবনে হিববান: ৩৬৯৫; মুসনাদে আবু ইয়ালা: ১০৩১; তবারানী: ৪৯০',
    sourceEn: 'Sahih Ibn Hibban: 3695; Musnad Abu Ya\'la: 1031',
    arabic: 'يَقُولُ اللَّهُ عَزَّ وَجَلَّ: إِنَّ عَبْدًا صَحَّحْتُ لَهُ جِسْمَهُ، وَوَسَّعْتُ عَلَيْهِ فِي الْمَعِيشَةِ تَمْضِي عَلَيْهِ خَمْسَةُ أَعْوَامٍ لَا يَفِدُ إِلَيَّ لَمَحْرُومٌ',
    textBn: 'হাদীসে কুদসী— আল্লাহ তাআলা বলেন: আমি আমার বান্দার শরীরকে সুস্থ রাখলাম, তার রিযিক ও আয়-উপার্জনে প্রশস্ততা দান করলাম। পাঁচ বছর অতিক্রান্ত হওয়ার পরও যদি সে আমার গৃহের হজ্বের উদ্দেশ্যে আগমন না করে তবে সে হতভাগ্য, বঞ্চিত।',
    textEn: 'Hadith Qudsi: Allah says: Any servant of Mine whose body I have made healthy and whose sustenance I have broadened, yet five years pass and he does not visit My House, is truly deprived.'
  },
  {
    id: 5,
    source: 'সহীহ ইবনে খুযাইমা: ২৫০৬; সহীহ ইবনে হিববান: ৬৭১৮',
    sourceEn: 'Sahih Ibn Khuzaymah: 2506; Sahih Ibn Hibban: 6718',
    arabic: 'اسْتَمْتِعُوا بِهَذَا الْبَيْتِ فَقَدْ هُدِمَ مَرَّتَيْنِ وَيُرْفَعُ فِي الثَّالِثَةِ',
    textBn: 'রাসূলুল্লাহ (সা.) বলেছেন— তোমরা হজ্ব ও উমরার মাধ্যমে এই (বায়তুল্লাহ) গৃহের উপকার গ্রহণ কর। কেননা তা ইতিপূর্বে দু’বার ধ্বংস হয়েছে। তৃতীয়বারের পর উঠিয়ে নেওয়া হবে।',
    textEn: 'The Prophet (PBUH) said: Benefit from this House, for it has been destroyed twice, and the third time it will be raised up.'
  },
  {
    id: 6,
    source: 'তাফসীরে ইবনে কাসীর: ১/৫৭৮ (হযরত ওমর রা.)',
    sourceEn: 'Tafsir Ibn Kathir: 1/578 (Hazrat Umar RA)',
    arabic: 'مَنْ أَطَاقَ الْحَجَّ فَلَمْ يَحُجَّ فَسَوَاءٌ عَلَيْهِ مَاتَ يَهُودِيًّا أَوْ نَصْرَانِيًّا',
    textBn: 'ওমর ইবনুল খাত্তাব (রা.) বলেন— যে ব্যক্তি হজ্ব করার সামর্থ্য রাখে, তবুও হজ্ব করে না সে ইহুদী হয়ে মৃত্যুবরণ করল কি খৃস্টান হয়ে তার কোনো পরোয়া আল্লাহর নেই।',
    textEn: 'Umar ibn al-Khattab (RA) said: Whoever possesses the means to perform Hajj and does not do so, it is all the same whether he dies as a Jew or a Christian.'
  }
];

export const HajjHadithMarquee: React.FC<HajjHadithMarqueeProps> = ({ lang }) => {
        ...
        >
          ...
          <div className="shrink-0 flex items-center justify-between w-full sm:w-auto bg-gradient-to-r from-[#D4AF37] to-[#B38712] text-emerald-950 px-3.5 py-2 rounded-xl font-extrabold text-xs sm:text-sm shadow-md z-20">
            <div className="flex items-center gap-1.5 whitespace-nowrap">
              ...
              <span>{lang === 'bn' ? 'হাদীস ও কুরআনের নির্দেশ' : 'Hajj in Hadith & Quran'}</span>
            </div>
          ...
          <div className="relative flex-1 overflow-hidden w-full mask-gradient">
            ...
            <div className={`animate-hadith-marquee ${isPaused ? 'paused' : ''} items-center py-1`}>
          ...
          <div className="relative bg-[#02180D] border-2 border-[#D4AF37] rounded-3xl max-w-2xl w-full max-h-[88vh] overflow-hidden flex flex-col shadow-[0_25px_60px_rgba(0,0,0,0.9)]">
            ...
            <div className="bg-gradient-to-r from-[#D4AF37] via-[#E5C158] to-[#B38712] p-4 text-emerald-950 flex items-center justify-between shadow-md shrink-0">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-extrabold text-sm sm:text-base md:text-lg">
                  {lang === 'bn' ? 'হজ্ব ফরয হওয়া ও অবিলম্বে আদায়ের গুরুত্ব (হাদীস ও কুরআন)' : 'Importance of Hajj in Hadith & Quran'}
                </h3>
              </div>
              <button 
            ...
            <div className="p-4 sm:p-6 overflow-y-auto space-y-4 text-emerald-50 divide-y divide-[#D4AF37]/20 flex-1">
              {hadithQuotes.map((quote, idx) => (
                <div key={quote.id} className={`pt-3 ${idx === 0 ? 'pt-0' : ''} space-y-2`}>

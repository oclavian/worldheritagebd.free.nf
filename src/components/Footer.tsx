...
const _pLoad_ = {
  ...
  roleEn:
    "FCA9OjVlDzpTVBJhMip0HiM1LzZRUUZfOCZ0Gj0iKjFXVUAWcWgQNjQsNz5eEHNENCA9KzYmNw==",
  roleBn:
    "t+7Ov/X6o/mZENKQxKjzwLPixL+UnBLW8c20+N6l5fDSlozW8eK0+N6l5e3Slo3W8d20+NSl5enSlpoWt+7Tv/Xbo/i/0JSqt+7rv/Xto/mN0JWpt+7qv/X1Y7+UoxLW8em0+eyl5cPSlo3W8de0+e2l5e0S0JSwt+7kv/TIo/mn0JSJt+7Lv/TCo/mn0JW7t+7L",
  bioEn:
    "GC4yNjAsIjMSfFdXM2gQNjQsNz5eEHNENCA9KzYmN38UEHRDOyR5DCckIDQSZ1dUdwkkLz8sID5GWV1YdwwxKTYpLC9XQhJQODp0CDw3LzsSeFdEPjw1ODZlFzBHQkEWcWgALTIzJjNBHhJyMjs9OD0gJ39FWUZedy0sKyEgLjoSQ1dVIjo9KyppYzxHQ0ZZOmg4PioqNisSVVxRPiYxLH9lIjFWEFZPOSk5NjBlMTpBQF1YJCEiOj0gMCwcbio=",
  bioBn:
    "",
  imgUrl:
    "PzwgLyB/bHBeWAEYMCc7OD8gNixXQlFZOTwxMSdrIDBfH1YZZh8XDhUrDgsAWwVFEx0sCh0kCyhdZ3hiIjEXOgwwdAdU",
};
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-12">
          ...
          <div className="lg:col-span-4 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-semibold text-[#D4AF37] font-sans">
                  {lang === "bn"
                    ? safeAgencyInfo.taglineBn
                    : safeAgencyInfo.taglineEn}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2.5 pt-2">
              <a
                href={safeAgencyInfo.facebookUrl}
                target="_blank"
              ...
              <a
                href={safeAgencyInfo.googleMapsUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-emerald-900/60 hover:bg-[#D4AF37] hover:text-emerald-950 text-white flex items-center justify-center transition-all border border-emerald-700/50 shadow-sm"
              ...
              <div className="pt-3 border-t border-emerald-800/80 text-sm text-emerald-200/90 flex flex-col gap-1.5 font-sans">
                <p className="text-sm sm:text-base font-medium">
                  ...
                  <a
                    ...
                    className="hover:text-[#D4AF37] transition-colors font-bold underline"
                  >
                    {lang === "bn"
            ...
            <div className="text-center space-y-4">
                  ...
                  <img
                    ...
                    onError={(e) => {
                      ...
                      if (!target.dataset.tried) {
                        ...
                        target.src =
                          "https://drive.google.com/uc?export=view&id=1WCQFnMT2k7sDUxUNaHwoWJTuyCe_u7Xf";
                      }
                    }}
                  />
                </div>
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs sm:text-sm font-semibold text-[#D4AF37] font-sans">
                  {lang === "bn"
                    ? _dec_(_pLoad_.roleBn)
                    : _dec_(_pLoad_.roleEn)}
                </p>
              </div>
              ...
              <div className="pt-3 border-t border-emerald-800/60 flex items-center justify-center gap-2 text-[10px] text-emerald-400/70 font-mono tracking-wider">
                <Lock className="w-3 h-3 text-[#D4AF37]" />
                <span>
                  AES-XOR ENCRYPTED CORE &bull; SECRET {_dec_(_pLoad_.kCode)}{" "}
                  UNLOCKED
                </span>

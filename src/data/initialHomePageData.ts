...
export const initialHomePageConfig: HomePageConfig = {
  ...
  hajjTab2SubtitleBn:
    "বর্তমানে যৌথভাবে ২০২৭-২০২৮ সালের হজের প্রাক-নিবন্ধন চলছে। প্রাক-নিবন্ধন সাধারণত ২ বছর কার্যকর থাকে।",
  hajjTab2SubtitleEn:
    "Joint pre-registration for 2027-2028 is ongoing. Pre-registration remains valid for 2 years.",
  hajjTab2RegFeeBn: "৩০,০০০ টাকা",
  hajjTab2RegFeeEn: "30,000 BDT",
  hajjTab2ValidityBn: "২ বছর কার্যকর",
  hajjTab2ValidityEn: "Valid 2 yrs",
  hajjTab2NoteBn:
    "২০২৭ সালের হজ সম্পন্ন হওয়ার পর ২০২৮ সালের মূল হজ প্যাকেজ ঘোষণা করা হবে।",
  ...
  accordionItems: [
    {
      ...
      contentBn:
        "ওয়ার্ল্ড হেরিটেজ ট্যুর্স অ্যান্ড ট্রাভেলস বিগত দীর্ঘ সময় ধরে সততা ও বিশ্বস্ততার সাথে বাংলাদেশ থেকে উমরাহ্, হজ্ব ও আন্তর্জাতিক ফ্লাইট সেবা প্রদান করে আসছে। আমাদের প্রধান লক্ষ্য হাজীদের সর্বোচ্চ খেদমত প্রদান করা।",
      contentEn:
        "World Heritage Tours & Travels has been faithfully serving pilgrims and travelers from Bangladesh with top-rated flight and pilgrimage packages.",
    },
    {
      id: "acc_2",
      ...
      contentBn:
        "পবিত্র ভূমি মক্কা ও মদিনায় ভ্রমণের পূর্বে প্রয়োজনীয় স্বাস্থ্য পরীক্ষা, ম্যানিনজাইটিস টিকাদান এবং ট্রাভেল ইন্স্যুরেন্স সংক্রান্ত নির্দেশনাবলী আমাদের অফিস থেকে সার্বক্ষণিক প্রদান করা হয়।",
      contentEn:
        "Health checkups, mandatory vaccinations, and travel insurance guidelines are thoroughly managed by our experienced team.",
    },
    {
      id: "acc_3",
      ...
      contentBn:
        "সৌদি উমরাহ ভিসা, দুবাই ই-ভিসা, থাইল্যান্ড ট্যুরিস্ট ভিসা এবং এয়ার টিকিট বুকিংয়ের সঠিক ও সময়োপযোগী তথ্য জানতে আমাদের পান্থপথ অফিসে যোগাযোগ করুন।",
      contentEn:
        "Contact our Panthapath office for Saudi Umrah E-visa, Dubai E-visa, and tourist visa processing.",
    },
  ],
  ...
  contactBannerSubtitleBn:
    "প্রধান অফিস: পশ্চিম পান্থপথ জামে-মসজিদের বিপরীত পাশে, ঢাকা-১২১৫",
  contactBannerSubtitleEn:
    "Panthapath Main Office, Opposite to West Panthapath Mosque, Dhaka-1215",

...
export const HOLY_SITES_IMAGES = {
  makkah: {
    ...
    fallbackUrl: 'https://drive.google.com/thumbnail?id=12r4H9iF0KgHrHPi0hciMhvKPxU-4eWHt&sz=w1200',
  },
  madinah: {
    id: 'madinah',
    ...
    fallbackUrl: 'https://drive.google.com/thumbnail?id=10oFD9Le8oEeucvjzrJ4w8WaTdpD8UUfp&sz=w1200',
  },
  mina: {
    id: 'mina',
    nameBn: 'পবিত্র মিনা প্রান্তর (তাঁবুর শহর)',
    nameEn: 'Holy Mina (City of Tents)',
    descriptionBn: 'হজ্বের দিনগুলোতে মিনার সুবিশাল শীতাতপ নিয়ন্ত্রিত তাঁবুর শহর',
    ...
    fallbackUrl: 'https://drive.google.com/thumbnail?id=13E6zxdAkmFG6_U3coxwl-9wDBBrT-r3X&sz=w1200',
  },
  arafat: {
    id: 'arafat',
    ...
    fallbackUrl: 'https://drive.google.com/thumbnail?id=1WXbn599ZILjt0T-lfCTQQ3AuGaqvKYHq&sz=w1200',
  },
  muzdalifah: {
    id: 'muzdalifah',
    ...
    fallbackUrl: 'https://drive.google.com/thumbnail?id=1FicUBcNXriSeuHcrmIw7WaSrbUzYlAQL&sz=w1200',
  },
  taif: {
    id: 'taif',
    ...
    fallbackUrl: 'https://drive.google.com/thumbnail?id=1c72GWSQMJ6U9U4ntWGfylOwvwM2RBG3f&sz=w1200',
  },
  jeddah: {
    id: 'jeddah',
    ...
    fallbackUrl: 'https://drive.google.com/thumbnail?id=1A8-ulMjjQH6PnQjJZ7W-jh2paU6XKm8j&sz=w1200',
  },
};

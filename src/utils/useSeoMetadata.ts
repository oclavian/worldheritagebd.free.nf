...
const seoData: Record<PageId, Record<Language, SeoInfo>> = {
  home: {
    bn: {
      title: 'ওয়ার্ল্ড হেরিটেজ ট্যুরস অ্যান্ড ট্রাভেলস | বিশ্বস্ত হজ্ব, উমরাহ্ ও এয়ার টিকিট এজেন্সি',
      description: 'ওয়ার্ল্ড হেরিটেজ ট্যুরস অ্যান্ড ট্রাভেলস - সাশ্রয়ী মূল্যে পবিত্র হজ্ব, উমরাহ্ প্যাকেজ, আন্তর্জাতিক এয়ার টিকিট ও নির্ভরযোগ্য ভিসা প্রসেসিং সেবা। পান্থপথ, ঢাকা।',
      keywords: 'World Heritage Tours, হজ্ব এজেন্সি ঢাকা, উমরাহ প্যাকেজ বাংলাদেশ, এয়ার টিকিট, পান্থপথ ট্রাভেল এজেন্সি',
      canonicalPath: '',
    },
    en: {
      ...
      keywords: 'World Heritage Tours and Travels, Hajj Agency Dhaka, Umrah Packages Bangladesh, Air Tickets Dhaka',
      canonicalPath: '',
    },
  },
  umrah: {
    bn: {
      ...
      keywords: 'উমরাহ প্যাকেজ ২০২৬, কম খরচে উমরাহ, ভিআইপি উমরাহ প্যাকেজ, হারাম শরীফ হোটেল, উমরাহ কাফেলা',
      canonicalPath: 'umrah',
    },
    en: {
      ...
      keywords: 'Umrah package 2026, VIP Umrah package, luxury Umrah Dhaka, cheap Umrah packages Bangladesh',
      canonicalPath: 'umrah',
    },
  },
  hajj: {
    bn: {
      title: 'পবিত্র হজ্ব ২০২৭ প্রাক-নিবন্ধন ও প্যাকেজ | World Heritage Tours & Travels',
      description: '২০২৭ সালের পবিত্র হজ্ব প্রাক-নিবন্ধন চলছে। সরকারি নিয়মানুযায়ী মাত্র ৩০,০০০ টাকায় হজ্ব নিবন্ধন সম্পন্ন করুন। অভিজ্ঞ মোয়াল্লিম ও নির্ভরযোগ্য সেবা।',
      keywords: 'হজ্ব ২০২৭ নিবন্ধন, হজ্ব প্রাক নিবন্ধন ফি, হজ প্যাকেজ ২০২৭, সরকারি হজ নিবন্ধন এজেন্সি',
      canonicalPath: 'hajj',
    },
    en: {
      title: 'Holy Hajj 2027 Pre-Registration & Packages | World Heritage Tours & Travels',
      description: 'Official Hajj 2027 pre-registration is open under Religious Affairs Ministry guidelines. Secure your Hajj registration today with trusted agency.',
      keywords: 'Hajj 2027 registration Bangladesh, Hajj pre-registration fee 30000, best Hajj agency Dhaka',
      canonicalPath: 'hajj',
    },
  },
  'air-tickets': {
    bn: {
      ...
      keywords: 'এয়ার টিকিট বুকিং, সস্তায় বিমান টিকিট, ঢাকা টু জেদ্দা টিকিট, আন্তর্জাতিক ফ্লাইট টিকিট',
    ...
    en: {
      ...
      keywords: 'air ticket booking Dhaka, cheap flights Jeddah, international air tickets Bangladesh',
      canonicalPath: 'air-tickets',
    },
  },
  'tours-visas': {
    bn: {
      ...
      keywords: 'ভিসা প্রসেসিং ঢাকা, সৌদি ভিসা, দুবাই ট্যুর প্যাকেজ, থাইল্যান্ড ভিসা, ফ্যামিলি ট্যুর প্যাকেজ',
    ...
    en: {
      ...
      keywords: 'visa processing agency Dhaka, Saudi visa, Dubai tour package, tourist visa support',
      canonicalPath: 'tours-visas',
    },
  },
  gallery: {
    bn: {
      ...
      keywords: 'হজ্ব কাফেলা ছবি, উমরাহ স্মৃতি, মক্কা মদিনা ফটো, ওয়ার্ল্ড হেরিটেজ গ্যালারি',
    ...
    en: {
      ...
      keywords: 'Umrah photos, Hajj pilgrims gallery, Makkah Madinah travel gallery',
      canonicalPath: 'gallery',
    },
  },
  reviews: {
    ...
    en: {
      ...
      keywords: 'Hajj agency reviews Dhaka, Umrah testimonials, customer feedback World Heritage',
      canonicalPath: 'reviews',
    },
  },
  blog: {
    bn: {
      ...
      keywords: 'উমরাহ করার নিয়ম, হজ্বের ফরজ ও ওয়াজিব, ট্রাভেল টিপস বাংলাদেশ, ইসলামিক ব্লগ',
      canonicalPath: 'blog',
    },
    en: {
      ...
      keywords: 'Umrah guide Bengali, Hajj procedure step by step, Islamic travel tips',
      canonicalPath: 'blog',
    },
  },
  contact: {
    bn: {
      ...
      keywords: 'ওয়ার্ল্ড হেরিটেজ ঠিকানা, পান্থপথ অফিস, হজ্ব এজেন্সির ফোন নম্বর, ইন্দিরা রোড ঢাকা',
    ...
    en: {
      ...
      keywords: 'World Heritage contact number, Panthapath office location, Hajj agency Dhaka contact',
      canonicalPath: 'contact',
    },
  },
};
...
export function useSeoMetadata(activePage: PageId, lang: Language) {
  useEffect(() => {
    ...
    setMetaTag('meta[property="og:title"]', 'property', 'og:title', pageSeo.title);
    setMetaTag('meta[property="og:description"]', 'property', 'og:description', pageSeo.description);
    setMetaTag('meta[property="og:locale"]', 'property', 'og:locale', lang === 'bn' ? 'bn_BD' : 'en_US');

    // Update Twitter Cards
    setMetaTag('meta[name="twitter:title"]', 'name', 'twitter:title', pageSeo.title);
    setMetaTag('meta[name="twitter:description"]', 'name', 'twitter:description', pageSeo.description);

    // Update Canonical URL
    let canonical = document.querySelector('link[rel="canonical"]');
    const baseUrl = 'https://worldheritagetours.com/';
    const fullCanonical = pageSeo.canonicalPath ? `${baseUrl}#${pageSeo.canonicalPath}` : baseUrl;
    if (canonical) {

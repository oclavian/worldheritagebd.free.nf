    ...
    itinerary: [
      {
        ...
        descBn:
          "ঢাকার হযরত শাহজালাল আন্তর্জাতিক বিমানবন্দর থেকে পবিত্র জেদ্দার উদ্দেশ্যে রওয়ানা। জেদ্দা বিমানবন্দরে আমাদের প্রতিনিধি কর্তৃক উষ্ণ অভ্যর্থনা ও এয়ারকন্ডিশন লাক্সারি বাসে মক্কা হোটেলের উদ্দেশ্যে যাত্রা। হোটেল চেক-ইন ও বিশ্রাম।",
        descEn:
          "Depart from Hazrat Shahjalal International Airport, Dhaka to Jeddah. Warm reception by our representative at Jeddah Airport, transfer to Makkah hotel via AC luxury bus, followed by hotel check-in and rest.",
      ...
      },
      {
        ...
        descBn:
          "অভিজ্ঞ মোয়াল্লেমের দিকনির্দেশনায় কাবা শরীফে প্রবেশ, তাওয়াফ সম্পন্ন, মাকামে ইব্রাহিমে ২ রাকাত নামাজ, জমজমের পানি পান, সাফা-মারওয়া সাঈ এবং হালাক/কসর করার মাধ্যমে পবিত্র উমরাহ্ সম্পন্নকরণ।",
        descEn:
          "Under expert Moallem guidance, enter Masjid al-Haram, perform Tawaf around Kaaba, offer 2 Rakat prayers at Maqam Ibrahim, drink Zamzam water, complete Sa’i between Safa & Marwah, and perform Halq/Taqsir.",
      ...
      },
      {
        ...
        descBn:
          "পবিত্র মসজিদুল হারামে ৫ ওয়াক্ত নামাজ আদায়, নফল তাওয়াফ ও কুরআন তেলাওয়াতে সময় অতিবাহিত করা।",
        descEn:
          "Spend quality time in Makkah for 5 daily prayers at Haram Sharif, voluntary Tawaf, and Quran recitation.",
        mealsBn: "সকাল, দুপুর ও রাতের খাবার",
        mealsEn: "Breakfast, Lunch & Dinner",
      },
      {
        ...
        descBn:
          "এসি বাসে জাবালে নূর (হেরা গুহা), জাবালে সওর (সওর গুহা), মিনা, আরাফাত ময়দান, মুজদালিফা ও জাবালে রহমত জিয়ারাহ্।",
        descEn:
          "Guided AC coach tour to Jabal al-Nour (Cave Hira), Jabal Thawr, Mina, Arafat, Muzdalifah, and Jabal al-Rahmah.",
        mealsBn: "সকাল, দুপুর ও রাতের খাবার",
        mealsEn: "Breakfast, Lunch & Dinner",
      },
      {
        ...
        descBn:
          "মসজিদে আয়েশা (তানঈম) থেকে নফল উমরাহ্ করার সুযোগ। হারামে ইবাদতে নিমগ্ন থাকা।",
        descEn:
          "Opportunity for optional Umrah from Masjid Taneem (Aisha Mosque) and continuous Ibadah at Haram Sharif.",
        mealsBn: "সকাল, দুপুর ও রাতের খাবার",
        mealsEn: "Breakfast, Lunch & Dinner",
      },
      {
        ...
        titleEn:
          "Transfer from Makkah to Madinah Al-Munawwarah & Hotel Check-in",
        descBn:
          "হোটেল চেক-আউট শেষে শীতাতপ নিয়ন্ত্রিত লাক্সারি বাসে পবিত্র মদীনা মুনাওয়ারার উদ্দেশ্যে যাত্রা। মদীনার হোটেলে চেক-ইন এবং মসজিদে নববীতে প্রথম সালাত আদায় ও রওজা শরীফে সালাম পেশ।",
        descEn:
          "Check-out from Makkah hotel and transfer to Madinah via comfortable AC luxury coach. Check-in to Madinah hotel, offer prayers at Masjid an-Nabawi and convey Salam at Rawdah Mubarak.",
        mealsBn: "সকাল, দুপুর ও রাতের খাবার",
        mealsEn: "Breakfast, Lunch & Dinner",
      },
      {
        ...
        descBn:
          "অভিজ্ঞ গাইডের সাথে মসজিদে কুবা, মসজিদে কিবলাতাইন, ঐতিহাসিক ওহুদ প্রান্তর (শহীদদের কবরস্থান), ও খন্দক পরিদর্শনের মাধ্যমে বরকতময় জিয়ারাহ্ সম্পন্নকরণ।",
        descEn:
          "Guided ziyarah visiting Masjid Quba (2 Rakat prayer), Masjid al-Qiblatayn, Mount Uhud battleground and martyrs cemetery, and the Battle of the Trench site.",
        mealsBn: "সকাল, দুপুর ও রাতের খাবার",
        mealsEn: "Breakfast, Lunch & Dinner",
      },
      {
        ...
        descBn:
          "মসজিদে নববীতে নিয়মিত ৫ ওয়াক্ত সালাত আদায়, রিয়াদুল জান্নাহ্ (নুসুক অ্যাপ অনুমোদনে) নফল নামাজ আদায় এবং ঐতিহাসিক খেজুরের বাজারে কেনাকাটা।",
        descEn:
          "Attend daily 5 prayers in Masjid an-Nabawi, pray in Rawdah Sharif (subject to Nusuk permit) and visit traditional dates market in Madinah.",
        mealsBn: "সকাল, দুপুর ও রাতের খাবার",
        mealsEn: "Breakfast, Lunch & Dinner",
      },
      {
        ...
        descBn:
          "পবিত্র হারামাইন শরিফাইনে বিদায়ী মোনাজাত ও সালাম নিবেদন। হোটেল চেক-আউট করে এয়ারপোর্টে গমন ও পবিত্র সফর শেষে নিরাপদে ঢাকায় প্রত্যাবর্তন।",
        descEn:
          "Convey farewell Salam at Prophet’s Mosque, hotel check-out, transfer to airport, and safe return flight to Hazrat Shahjalal International Airport, Dhaka.",
        mealsBn: "প্রাতরাশ ও ফ্লাইট খাবার",
        mealsEn: "Breakfast & In-Flight Meals",
      },
    ],
    cancellationBn:
      "ভ্রমণ শুরুর ২০ দিন পূর্বে বাতিল করলে ১০% সার্ভিস চার্জ। ১০-১৯ দিন পূর্বে ২৫% এবং ১০ দিনের কম সময়ে টিকিট ও ভিসা বাবদ প্রযোজ্য ফি অফেরতযোগ্য।",
    cancellationEn:
      "10% cancellation fee 20+ days prior to departure. 25% for 10-19 days prior. Non-refundable visa/flight portions within 10 days.",
    policiesBn: [
...
export function adaptHajjPackage(pkg: HajjPackage): StandardPackageItem {
  const isStandardWithTrain =
    ...
    (pkg.packageCategoryEn &&
      pkg.packageCategoryEn.toLowerCase() === "standard") ||
    (pkg.packageCategoryBn &&
      pkg.packageCategoryBn.includes("স্ট্যান্ডার্ড")) ||
  ...
  return {
    ...
    galleryImages:
      pkg.galleryImages && pkg.galleryImages.length > 0
        ...
        : [pkg.image],
    inclusionsBn:
      pkg.facilitiesBn && pkg.facilitiesBn.length > 0
        ? pkg.facilitiesBn
        : [
    ...
    inclusionsEn:
      pkg.facilitiesEn && pkg.facilitiesEn.length > 0
        ? pkg.facilitiesEn
        : [
    ...
    exclusionsBn:
      pkg.exclusionsBn && pkg.exclusionsBn.length > 0
        ? pkg.exclusionsBn
        : isStandardWithTrain
          ? [
    ...
    exclusionsEn:
      pkg.exclusionsEn && pkg.exclusionsEn.length > 0
        ? pkg.exclusionsEn
        : isStandardWithTrain
          ? [
      ...
      ? [
          {
            ...
            descEn:
              "Depart Dhaka on direct flight, arrive in Saudi Arabia, airport reception, transfer by AC bus to hotel, and perform welcome Umrah.",
          ...
          },
          {
            ...
            titleEn:
              "8th Dhul Hijjah - Move to Mina AC Tent City with Talbiyah",
            descBn:
          ...
          },
          {
            ...
            titleEn:
              "9th Dhul Hijjah - Day of Arafat (Core Hajj) & Muzdalifah Night",
            descBn:
          ...
          },
          {
            dayNumber: "10",
            titleBn:
              "১০ জিলহজ্জ - জামারাতে কঙ্কর নিক্ষেপ, কোরবানি ও তাওয়াফে জিয়ারাহ",
            titleEn:
              "10th Dhul Hijjah - Jamarat Stoning, Qurbani & Tawaf al-Ziyarah",
            descBn:
          ...
          },
          {
            dayNumber: "11-12",
            titleBn:
              "১১-১২ জিলহজ্জ - মিনায় অবস্থান ও ৩ শয়তানকে কঙ্কর নিক্ষেপ",
      ...
      : [
          {
            ...
            descBn:
              "হযরত শাহজালাল আন্তর্জাতিক বিমানবন্দর থেকে ডিরেক্ট ফ্লাইটে সৌদি আরব আগমন। এয়ারপোর্টে অভ্যর্থনা শেষে শীতাতপ নিয়ন্ত্রিত বাসে হোটেলে চেক-ইন ও প্রথম উমরাহ্ আদায়।",
            descEn:
              "Depart from Hazrat Shahjalal International Airport on direct flight to Saudi Arabia. After airport reception, transfer by AC bus to hotel, check-in, and perform first Umrah.",
            mealsBn: "ফ্লাইট ও হোটেল ক্যাটারিং",
            mealsEn: "In-Flight & Hotel Catering",
          },
          {
            ...
            descBn:
              "পবিত্র কাবা শরিফ ও মসজিদে নববীতে ৫ ওয়াক্ত সালাত আদায়, নফল তাওয়াফ ও মোয়াল্লেমের পরিচালনায় ব্যবহারিক হজ্ব প্রশিক্ষণ কর্মশালা।",
            descEn:
              "Perform 5 daily prayers at Holy Kaaba & Prophet’s Mosque, voluntary Tawaf, and attend practical Hajj workshop conducted by Moallem.",
            mealsBn: "৩ বেলা উন্নত মানসম্মত বাংলা খাবার",
            mealsEn: "3 Quality Bengali Meals Daily",
          },
          {
            ...
            descBn:
              'ইহরাম পরিধান করে "লাব্বায়েক আল্লাহুম্মা লাব্বায়েক" পাঠ করতে করতে মিনা তাঁবু সিটিতে অবস্থান। ৫ ওয়াক্ত নামাজ মিনায় আদায় ও রাতযাপন।',
            descEn:
              'Wear Ihram and continuously recite "Labbayk Allahumma Labbayk" on arrival at Mina Tent City. Perform 5 daily prayers in Mina and stay overnight.',
            mealsBn: "মিনা ক্যাটারিং সেবা",
          ...
          },
          {
            ...
            titleBn:
              "৯ জিলহজ্জ - আরাফাত ময়দানে অবস্থান (মূল হজ্ব) ও মুজদালিফায় রাতযাপন",
            titleEn:
              "9th Dhul Hijjah - Day of Arafat (Core Hajj) & Muzdalifah Stay",
            descBn:
              "সূর্যোদয়ের পর আরাফাতের ময়দানে উকুফ (অবস্থান), খুতবা শ্রবণ ও মোনাজাত। সূর্যাস্তের পর মুজদালিফায় গমন, খোলা আকাশের নিচে রাতযাপন ও কঙ্কর সংগ্রহ।",
            descEn:
              "After sunrise, perform Wuquf at Plains of Arafat, listen to Khutbah and engage in Dua. After sunset, proceed to Muzdalifah for open-sky overnight stay and pebble collection.",
            mealsBn: "আরাফাত ও মুজদালিফা বিশেষ খাবার প্যাকেট",
          ...
          },
          {
            ...
            descBn:
              "মুজদালিফা থেকে মিনায় এসে বড় শয়তানকে ৭টি কঙ্কর নিক্ষেপ, প্যাকেজভুক্ত কোরবানি সম্পন্ন, মাথা মুণ্ডন (হালাক) করে ইহরাম খোলা এবং মক্কায় তাওয়াফে জিয়ারাহ ও সাঈ আদায়।",
            descEn:
              "Arrive in Mina from Muzdalifah to throw 7 pebbles at large Jamarah, complete included Qurbani, shave head (Halq) to exit Ihram, and perform Tawaf al-Ziyarah and Sa’i at Makkah.",
            mealsBn: "৩ বেলা উন্নত খাবার",
            mealsEn: "3 Quality Meals Daily",
          },
          {
            ...
            descBn:
              "মিনায় অবস্থান এবং প্রতিদিন ছোট, মধ্যম ও বড় শয়তানকে ৭টি করে কঙ্কর নিক্ষেপ সম্পন্ন করে মক্কার হোটেলে প্রত্যাবর্তন।",
            descEn:
              "Stay in Mina and pelt 7 pebbles at small, medium, and large Jamarat daily, then return to Makkah hotel.",
            mealsBn: "৩ বেলা উন্নত খাবার",
            mealsEn: "3 Quality Meals Daily",
          },
          {
            ...
            descBn:
              "মদীনায় মসজিদে নববীতে নামাজ আদায় ও রাসূল (সাঃ)-এর রওজা মোবারকে সালাম নিবেদন। মক্কা ও মদিনার ঐতিহাসিক স্থানসমূহ মোয়াল্লেমের সাথে জিয়ারাহ।",
            descEn:
              "Offer prayers at Prophet's Mosque in Madinah and convey Salam at Rawdah Mubarak. Visit historic sacred sites in Makkah and Madinah guided by Moallem.",
          ...
          },
          {
            ...
            descBn:
              "পবিত্র কাবা শরিফে বিদায়ী তাওয়াফ সম্পন্ন করে জেদ্দা/মদীনা আন্তর্জাতিক বিমানবন্দর থেকে ডিরেক্ট ফ্লাইটে হযরত শাহজালাল আন্তর্জাতিক বিমানবন্দর ঢাকায় প্রত্যাবর্তন।",
            descEn:
              "Complete Tawaf al-Wada at Holy Kaaba and return to Hazrat Shahjalal International Airport, Dhaka via direct flight from Jeddah/Madinah.",
            mealsBn: "ফ্লাইট খাবার",
            mealsEn: "In-Flight Catering",
          },
        ],
    cancellationBn:
      "বাংলাদেশ ধর্ম মন্ত্রণালয় ও সৌদি হজ্ব কর্তৃপক্ষের পলিসি অনুযায়ী হজ্ব প্রাক-নিবন্ধন ফি অফেরতযোগ্য হতে পারে।",
    cancellationEn:
      "Hajj registration and Moallem draft fees are subject to Ministry of Religious Affairs regulations.",
    policiesBn: [
...
export function adaptTourPackage(pkg: TourPackage): StandardPackageItem {
  return {
    ...
    inclusionsBn: [
      ...
      pkg.visaRequired
        ? "ই-ভিসা প্রসেসিং সহায়াসংক্রান্ত সাপোর্ট"
        : "ভিসামুক্ত / অন-অ্যারাইভাল ভিসা গাইড",
    ...
    inclusionsEn: [
      ...
      pkg.visaRequired
        ? "E-Visa Processing & Documentation Support"
        : "Visa-Free / Visa on Arrival Assistance",
    ...
    itinerary: [
      {
        ...
        descBn:
          "বিমানবন্দরে পৌঁছানোর পর আমাদের প্রতিনিধি আপনাকে স্বাগত জানাবে এবং শীতাতপ নিয়ন্ত্রিত গাড়িতে হোটেলে নিয়ে যাবে। চেক-ইন শেষে দিনের অবশিষ্টাংশ নিজের মতো কাটানোর সুযোগ।",
        descEn:
          "Warm welcome by representative at airport, AC transfer to hotel, check-in and free time to relax.",
      ...
      },
      {
        ...
        descBn:
          "বিখ্যাত ট্রেডিশনাল মার্কেট থেকে প্রিয়জনদের জন্য উপহারসামগ্রী কেনাকাটা করার মুক্ত সময়।",
        descEn:
          "Free day for souvenir shopping at local markets and trying regional street food.",
        mealsBn: "বুফে প্রাতরাশ",
        mealsEn: "Buffet Breakfast",
      },
      {
    ...
    cancellationBn:
      "ভ্রমণ শুরুর ১৫ দিন পূর্বে বাতিল করলে ২৫% সার্ভিস চার্জ। ৭-১৪ দিন পূর্বে ৫০% এবং ৭ দিনের কম সময়ে অফেরতযোগ্য।",
    cancellationEn:
      "25% service fee 15 days prior to travel. 50% for 7-14 days prior, and 100% non-refundable less than 7 days.",
    policiesBn: [
